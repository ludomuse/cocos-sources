...
void LmRightSpotScene::runGame()
{
	...
	m_pSendingArea->setAnchorPoint(0,0.5);
	m_pSendingArea->setPosition(l_oVisibleSize.width-m_pSendingArea->getSpriteContentSize().width,l_oVisibleSize.height*0.5);
	...
	m_pFinishButton -> setPosition(Vect(l_oVisibleSize.width-m_pFinishButton->getContentSize().width*0.8,m_pFinishButton->getContentSize().height*0.5));
