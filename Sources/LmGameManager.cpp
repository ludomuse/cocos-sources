...
void LmGameManager::initPathsForResolution()
{
	...
	l_glview->setDesignResolutionSize(s_DesignResolutionSize.width, s_DesignResolutionSize.height, ResolutionPolicy::EXACT_FIT);
...
void LmGameManager::runGame()
{
	...
	if(!m_aInteractionSceneOfTheGame.at(0)->init())
	{
		CCLOG("InteractionScene Crashed");
	}

	//run the first scene of the app
